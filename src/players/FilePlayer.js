...
var DASH_SDK_URL = 'https://cdnjs.cloudflare.com/ajax/libs/dashjs/2.9.0/dash.all.min.js';
    ...
    value: function load(url) {
      ...
      if (this.shouldUseDASH(url)) {
        (0, _utils.getSDK)(DASH_SDK_URL, DASH_GLOBAL).then(function (dashjs) {
          ...
          if(typeof _this2.props.protdata !== 'undefined' && _this2.props.protdata != null) {
           _this2.dash.setProtectionData(_this2.props.protdata);
           console.log("setting protection data");
           console.log(_this2.props.protdata);
          }
        });
      }
      if ((0, _utils.isMediaStream)(url)) {
